/*******************************************************************************
* MACRO: ADSL_Advanced.sas
* PURPOSE: Generate CDISC-compliant demographic baseline characteristics tables
*          (Tables 14.1.1, 14.1.2, 14.1.3) with p-values and overall counts
*	       following SDTM/ADaM standards
* 
* PARAMETERS:
...
* 
* EXAMPLE USAGE:
*   %adsl_advanced(pop=ITTFL, popdesc=Intent-to-Treat, popval=Y, trtvar=ARM, 
*           outrtf=/output/table_14_1_1.rtf, tablenum=14.1.1,
*           denom_mode=NONMISS, show_missing=Y, dostat=Y, 
*           test_type=ANOVA, dooverall=Y, trt_order=Placebo DrugA,
...
*   1. First, run the %adsl_advanced macro with dostat=N to create the work_population
*      dataset without p-values.
*      Example: %adsl_advanced(... , dostat=N, ...)
*
...
*      are violated for any key variable, re-run %adsl_advanced with test_type=KW.
*      Example: %adsl_advanced(... , dostat=Y, test_type=KW, ...)
*
...
%adsl_advanced(
  ...
  popval=Y,
  trtvar=ARM,
  outrtf=/home/&sysuserid/TLFs/Output/ADSL_Tables/Advanced_ADSL_Tables/ITT_Population/Table_14_1_1_ITT.rtf,
  tablenum=14.1.1,
  denom_mode=NONMISS,
  show_missing=Y,
  dostat=Y,
...
%adsl_advanced(
  ...
  popval=Y,
  trtvar=ARM,
  outrtf=/home/&sysuserid/TLFs/Output/ADSL_Tables/Advanced_ADSL_Tables/FAS_Population/Table_14_1_3_FAS.rtf,
  tablenum=14.1.3,
  denom_mode=NONMISS,
  show_missing=Y,
  dostat=Y,
...
%adsl_advanced(
  ...
  popval=Y,
  trtvar=ARM,
  outrtf=/home/&sysuserid/TLFs/Output/ADSL_Tables/Advanced_ADSL_Tables/ITT_Population/Table_14_1_1_ITT.pdf,
  tablenum=14.1.1,
  denom_mode=NONMISS,
  show_missing=Y,
  dostat=Y,
...
%adsl_advanced(
  ...
  popval=Y,
  trtvar=ARM,
  outrtf=/home/&sysuserid/TLFs/Output/ADSL_Tables/Advanced_ADSL_Tables/SAF_Population/Table_14_1_2_SAF.pdf,
  tablenum=14.1.2,
  denom_mode=NONMISS,
  show_missing=Y,
  dostat=Y,
...
%adsl_advanced(
  ...
  popval=Y,
  trtvar=ARM,
  outrtf=/home/&sysuserid/TLFs/Output/ADSL_Tables/Advanced_ADSL_Tables/FAS_Population/Table_14_1_3_FAS.pdf,
  tablenum=14.1.3,
  denom_mode=NONMISS,
  show_missing=Y,
  dostat=Y,
